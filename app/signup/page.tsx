...
export default function SignUp() {
	const { inputValue: avatarName, onChangeHandler: onAvatarNameChangeHandler , isTouched: isAvatarNameTouched, isInputValueValid: isAvatarNameValid, onBlurHandler: onAvatarNameBlurHandler} =
		useInputField((value) => {
			const avatarRegex = /^[A-Za-z0-9]{5,}$/;
			return avatarRegex.test(value);
		});

	const { inputValue: password, onChangeHandler: onPasswordChangeHandler, isTouched: isPasswordTouched, 
	...
	return (
        ...
        <p className="font-semibold text-xl">SignUp</p>
				...
				>
					...
					/>
					{isAvatarNameTouched && !isAvatarNameValid && (<FormFeedback>Invalid Avatar Name</FormFeedback>)}
					<InputField
						value={password}
						type="password"
						...
						onBlurHandler={onPasswordBlurHandler}
					/>
					{isPasswordTouched && !isPasswordValid && (<FormFeedback>Invalid Password</FormFeedback>)}
					<InputField
						...
						onBlurHandler={onConfirmPasswordBlurHandler}
					/>
					{isConfirmPasswordTouched && !isConfirmPasswordValid && (<FormFeedback>Invalid Confirm Password</FormFeedback>)}
